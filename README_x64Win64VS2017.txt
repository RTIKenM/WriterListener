...
1. Launch Visual Studio in one of two ways:
        - By typing ShapeType-x64Win64VS2017.sln in the
          Command Prompt window.
        - By opening Visual Studio on your machine and then opening the
          ShapeType-x64Win64VS2017.sln file (in the
...
2. Select Build Solution from the Build menu. (You can also right-click
   ShapeType_publisher or ShapeType_subscriber and
...
1. Right-click ShapeType_publisher and choose Debug > Start new instance.
2. Right-click ShapeType_subscriber and choose Debug > Start new instance.
...
2. Run C:\RTI\rti_connext_dds-6.0.1\bin\..\resource\scripts\rtisetenv_x64Win64VS2017.bat
...
> objs\x64Win64VS2017\ShapeType_publisher.exe <domain_id> <sample_count>
> objs\x64Win64VS2017\ShapeType_subscriber.exe <domain_id> <sample_count>